""" Setup script for the cli-ranker application.
...
_config = {
    "name": "cli-ranker",
    "url": "http://localhost:4321/project/cli-ranker/",
    "author": "Henrik Hain",
    "author_email": "mrhenhan@henrikhain.io",
    "package_dir": {"": "src"},
    "packages": find_packages("src"),
    "entry_points": {
        "console_scripts": ("cli-ranker = cli-ranker.cli:main",),
    },
    "data_files": ("etc/",),
}
